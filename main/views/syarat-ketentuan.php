                ...
                <div class="p-5 rounded-3" style="height: auto;">
                    <div class="d-flex justify-content-center align-items-center h-100">
                        <div class="text-black text-left" style="text-align: justify;">
                            <h2>Syarat dan Ketentuan Penggunaan SIUMAS - Aplikasi Iuran Masyarakat</h2>
                            </br></br>
                            <ol>
                                <li>
                                    <h5>Penerimaan Syarat dan Ketentuan</h5>
                                    <ol type="a">
                                        <li>
                                            Dengan mengakses dan menggunakan aplikasi SIUMAS, Anda dianggap telah
                                            membaca,
                                            memahami, dan menyetujui syarat dan ketentuan yang tercantum di bawah ini.
                                        </li>
                                        <li>
                                            Jika Anda tidak menyetujui syarat dan ketentuan ini, harap tidak melanjutkan
                                            penggunaan aplikasi SIUMAS.
                                        </li>
                                    </ol>
                                </li>
                                <li>
                                    <h5>Penggunaan Aplikasi</h5>
                                    <ol type="a">
                                        <li>
                                            Aplikasi SIUMAS diberikan untuk digunakan oleh pengurus desa dan bertujuan
                                            untuk
                                            pencatatan iuran keamanan dan kebersihan di lingkungan masyarakat tingkat
                                            dasar
                                            (RT/RW atau Desa).
                                        </li>
                                        <li>
                                            Anda setuju untuk menggunakan aplikasi SIUMAS sesuai dengan fungsi dan
                                            tujuan
                                            yang ditentukan.
                                        </li>
                                    </ol>
                                ...
                                <li>
                                    ...
                                    <ol type="a">
                                        <li>
                                            Kami berkomitmen untuk menjaga keamanan data pengguna dalam aplikasi SIUMAS.
                                        </li>
                                        <li>
                                            Anda bertanggung jawab untuk menjaga kerahasiaan informasi login Anda dan
                                            tidak
                                            mengungkapkannya kepada pihak ketiga.
                                        </li>
                                        <li>
                                            Kami tidak bertanggung jawab atas kehilangan, pencurian, atau penggunaan
                                            tidak
                                            sah akun Anda yang disebabkan oleh kelalaian atau pelanggaran Anda terhadap
                                            keamanan data.
                                        </li>
                                    </ol>
                                </li>
                                <li>
                                    ...
                                    <ol type="a">
                                        <li>
                                            Anda bertanggung jawab sepenuhnya atas data yang dimasukkan dalam aplikasi
                                            SIUMAS.
                                        </li>
                                        <li>
                                            Anda tidak diperkenankan untuk menggunakan aplikasi SIUMAS untuk tujuan yang
                                            melanggar hukum, melanggar hak privasi orang lain, atau merugikan pihak
                                            lain.
                                        </li>
                                        <li>
                                            Anda setuju untuk menggunakan aplikasi SIUMAS dengan itikad baik dan
                                            mengikuti
                                ...
                                <li>
                                    ...
                                    <ol type="a">
                                        <li>
                                            Kami berhak untuk mengubah syarat dan ketentuan penggunaan aplikasi SIUMAS
                                            sesuai kebijakan kami.
                                        </li>
                                        <li>
                                            Perubahan syarat dan ketentuan akan diinformasikan melalui pembaruan pada
                                            aplikasi SIUMAS atau melalui pemberitahuan kepada pengguna.
                                        </li>
                                        <li>
                                            Dengan melanjutkan penggunaan aplikasi SIUMAS setelah perubahan syarat dan
                                            ketentuan, Anda dianggap telah menyetujui perubahan tersebut.
                                        </li>
                                    </ol>
                                </li>
                                <li>
                                    <h5>Pemutusan Hubungan</h5>
                                    <ol type="a">
                                        <li>
                                            Kami berhak untuk memutuskan hubungan pengguna dengan aplikasi SIUMAS jika
                                            pengguna melanggar syarat dan ketentuan yang ditetapkan.
                                        </li>
                                        <li>
                                            Pemutusan hubungan dapat dilakukan tanpa pemberitahuan terlebih dahulu dan
                                            kami
                                            tidak bertanggung jawab atas kerugian yang mungkin ditimbulkan akibat
                                            pemutusan
                                            tersebut.
                                        </li>
                                    </ol>
                                ...
                                <li>
                                    <h5>Penafian Tanggung Jawab</h5>
                                    <ol type="a">
                                        <li>
                                            Aplikasi SIUMAS disediakan "sebagaimana adanya" tanpa jaminan apapun, baik
                                            secara eksplisit maupun implisit.
                                        </li>
                                        <li>
                                            Kami tidak bertanggung jawab atas kerugian atau kerusakan yang timbul dari
                                            penggunaan aplikasi SIUMAS.
                                        </li>
                                    </ol>
                                </li>
