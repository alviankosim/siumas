    ...
    <div class="sidebar sidebar-dark sidebar-fixed sidebar-narrow-unfoldable" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            ...
            <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                    ...
                    </svg> Iuran <span class="badge badge-sm bg-success ms-auto">Appr</span></a>
                <ul class="nav-group-items">
                    <li class="nav-item"><a class="nav-link" href="<?= base_url('iuran') ?>"><span class="nav-icon"></span> List Iuran <span class="badge badge-sm bg-success ms-auto">20</span></a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="index.html">
                    <svg class="nav-icon">
                        <use xlink:href="<?= base_url('', true) ?>vendors/@coreui/icons/svg/free.svg#cil-report-slash"></use>
                    </svg> Kelola Denda</a>
                <!-- <span class="badge badge-sm bg-info ms-auto">NEW</span> -->
            </li>
            <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            ...
            <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                ...
                <ul class="nav-group-items">
                    <li class="nav-item"><a class="nav-link" href="buttons/buttons.html"><span class="nav-icon"></span> List Pengguna</a></li>
                    <li class="nav-item"><a class="nav-link" href="buttons/dropdowns.html"><span class="nav-icon"></span> Tambah Pengguna</a></li>
                </ul>
            </li>
        </ul>
