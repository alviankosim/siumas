        ...
        <div class="body flex-grow-1 px-3">
            <div class="container-lg">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-header">Ringkasan Informasi dan Detil Pengeluaran</div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="border-start border-start-4 border-start-info px-3 mb-3"><small class="text-medium-emphasis">Pengeluaran Baru Bulan Ini</small>
                                                    <div class="fs-5 fw-semibold">2</div>
                                                </div>
                                            </div>
                                            <!-- /.col-->
                                            <div class="col-6">
                                                <div class="border-start border-start-4 border-start-danger px-3 mb-3"><small class="text-medium-emphasis">Pengeluaran on Progress</small>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <!-- /.col-->
                                            <div class="col-6">
                                                <div class="border-start border-start-4 border-start-success px-3 mb-3"><small class="text-medium-emphasis">Pengeluaran Terealisasi</small>
                                                    <div class="fs-5 fw-semibold">178</div>
                                                </div>
                                            </div>
                                            <!-- /.col-->
                                            <div class="col-6">
                                                <div class="border-start border-start-4 border-start-warning px-3 mb-3"><small class="text-medium-emphasis">Total Pengeluaran</small>
                                                    <div class="fs-5 fw-semibold">Rp 128.020.000</div>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.row-->
                                        ...
                                        <thead class="table-light fw-semibold">
                                            <tr class="align-middle">
                                                <th class="text-center">
                                                    <svg class="icon">
                                                        <use xlink:href="<?= base_url('', true) ?>vendors/@coreui/icons/svg/free.svg#cil-image"></use>
                                                    </svg>
                                                </th>
                                                <th>Pengeluaran</th>
                                        ...
                                        <tbody>
                                            <tr class="align-middle">
                                                <td class="text-center" style="vertical-align:middle;">
                                                    <div style="width: 150px;height: 150px;display: block;margin-left: auto;margin-right: auto;background:url('https://sipil.ft.undip.ac.id/wp-content/uploads/2021/09/Picture1-1.jpg');background-position:center;background-size:cover">
                                                        <!-- <img src="https://sipil.ft.undip.ac.id/wp-content/uploads/2021/09/Picture1-1.jpg" class="rounded img-fluid"> -->
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-center">
                                                    <svg class="icon icon-xl">
                                                        <use xlink:href="<?= base_url('', true) ?>vendors/@coreui/icons/svg/flag.svg#cif-us"></use>
                                                    </svg>
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                ...
                                                <td class="text-center">
                                                    <svg class="icon icon-xl">
                                                        <use xlink:href="<?= base_url('', true) ?>vendors/@coreui/icons/svg/brand.svg#cib-cc-mastercard"></use>
                                                    </svg>
                                                </td>
                                                <td>
                                            ...
                                            <tr class="align-middle">
                                                <td class="text-center" style="vertical-align:middle;">
                                                    <div style="width: 150px;height: 150px;display: block;margin-left: auto;margin-right: auto;background:url('https://i0.wp.com/www.emporioarchitect.com/upload/portofolio/jasa-arsitek-bogor-tajur-jawa-barat-desain-mushola-green-bamboo-terrace-114449314221020100523-0.jpg');background-position:center;background-size:cover">
                                                        <!-- <img src="https://i0.wp.com/www.emporioarchitect.com/upload/portofolio/jasa-arsitek-bogor-tajur-jawa-barat-desain-mushola-green-bamboo-terrace-114449314221020100523-0.jpg" class="rounded img-fluid"> -->
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>Yiorgos Avraamu</div>
